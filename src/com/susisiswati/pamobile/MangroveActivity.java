...
public class MangroveActivity extends TabActivity {
private Context mContext;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(testKoneksiInternet()){
			...
			intent = new Intent().setClass(this, MangroveTab1Activity.class);
			spec = tabhost.newTabSpec("tab1").setIndicator("Profil", null).setContent(intent);
			tabhost.addTab(spec);
			
			intent = new Intent().setClass(this, MangroveTab2Activity.class);
			spec = tabhost.newTabSpec("tab2").setIndicator("Kondisi Existing", null).setContent(intent);
			tabhost.addTab(spec);
				
			intent = new Intent().setClass(this, MangroveTab3Activity.class);
			...
			intent = new Intent().setClass(this, MangroveTab1LokalActivity.class);
			spec = tabhost.newTabSpec("tab1").setIndicator("Profil", null).setContent(intent);
			tabhost.addTab(spec);
