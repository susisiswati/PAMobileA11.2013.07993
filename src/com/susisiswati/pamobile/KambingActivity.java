...
public class KambingActivity extends TabActivity {
private Context mContext;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(testKoneksiInternet()){
			...
			intent = new Intent().setClass(this, KambingTab1Activity.class);
			spec = tabhost.newTabSpec("tab1").setIndicator("Profil", null).setContent(intent);
			tabhost.addTab(spec);
			
			intent = new Intent().setClass(this, KambingTab2Activity.class);
			spec = tabhost.newTabSpec("tab2").setIndicator("Kondisi Existing", null).setContent(intent);
			tabhost.addTab(spec);
				
			intent = new Intent().setClass(this, KambingTab3Activity.class);
			...
			intent = new Intent().setClass(this, KambingTab1LokalActivity.class);
			spec = tabhost.newTabSpec("tab1").setIndicator("Profil", null).setContent(intent);
			tabhost.addTab(spec);
