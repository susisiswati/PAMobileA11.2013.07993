...
public class BlumahActivity extends TabActivity {
private Context mContext;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(testKoneksiInternet()){
			...
			intent = new Intent().setClass(this, BlumahTab1Activity.class);
			spec = tabhost.newTabSpec("tab1").setIndicator("Profil", null).setContent(intent);
			tabhost.addTab(spec);
			
			intent = new Intent().setClass(this, BlumahTab2Activity.class);
			spec = tabhost.newTabSpec("tab2").setIndicator("Kondisi Existing", null).setContent(intent);
			tabhost.addTab(spec);
				
			intent = new Intent().setClass(this, BlumahTab3Activity.class);
			...
			intent = new Intent().setClass(this, BlumahTab1LokalActivity.class);
			spec = tabhost.newTabSpec("tab1").setIndicator("Profil", null).setContent(intent);
			tabhost.addTab(spec);
