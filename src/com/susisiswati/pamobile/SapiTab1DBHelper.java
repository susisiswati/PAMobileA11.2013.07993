...
public class SapiTab1DBHelper extends SQLiteOpenHelper {
	private static final String DATABASE_NAME = "dbsapi";
	public static final String KEY_ID = "_id";
	public static final String NAMA = "nama";
	public static final String NILAI = "nilai";
	
	public SapiTab1DBHelper(Context context) {
		super(context, DATABASE_NAME, null, 1);
	}

	// method createTable untuk membuat table
	public void createTable(SQLiteDatabase db) {
		db.execSQL("DROP TABLE IF EXISTS PROFILSAPI");
		db.execSQL("CREATE TABLE if not exists PROFILSAPI (_id INTEGER PRIMARY KEY AUTOINCREMENT, "
				+ "nama TEXT,"
				+ "nilai TEXT);");
	}
	...
	public void delAllData(SQLiteDatabase db) {
		db.delete("PROFILSAPI", null, null);
	}

	public Cursor fetchAllWisata(SQLiteDatabase db) {
		return db.query("PROFILSAPI", new String[] { KEY_ID, NAMA, NILAI}, null, null,
				null, null, null);
	}
