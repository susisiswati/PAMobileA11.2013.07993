...
private Context mContext;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(testKoneksiInternet()){
			...
			intent = new Intent().setClass(this, BandengTab1Activity.class);
			spec = tabhost.newTabSpec("tab1").setIndicator("Profil", null).setContent(intent);
			tabhost.addTab(spec);
			
			intent = new Intent().setClass(this, BandengTab2Activity.class);
			spec = tabhost.newTabSpec("tab2").setIndicator("Kondisi Existing", null).setContent(intent);
			tabhost.addTab(spec);
				
			intent = new Intent().setClass(this, BandengTab3Activity.class);
			...
			intent = new Intent().setClass(this, BandengTab1LokalActivity.class);
			spec = tabhost.newTabSpec("tab1").setIndicator("Profil", null).setContent(intent);
			tabhost.addTab(spec);
